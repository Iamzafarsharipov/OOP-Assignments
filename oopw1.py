...
count=FitnessClass.total_classes
print(f"Total classes:{count}")
print()
print("======================================")
print()
box=FitnessClass("Box","Zafarbek")
box.display_class()
box.add_participant("Sardor")
box.add_participant("Olim")
box.add_participant("Sanjar")
box.add_participant("Komil")
box.remove_participant("Olim")
box.remove_participant("Sarvar")
count=FitnessClass.total_classes
print(f"Total classes:{count}")
